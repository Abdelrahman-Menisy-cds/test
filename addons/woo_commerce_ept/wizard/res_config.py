...
class WooInstanceConfig(models.TransientModel):
    ...
    def test_and_reset_woo_credentials(self):
        ...
        instance = woo_instance_obj.browse(self.env.context.get('active_id'))
        ...
        if self.env.context.get('is_test_connection'):
...
class ResConfigSettings(models.TransientModel):
    ...
    def _get_woo_default_financial_statuses(self):
        if self.env.context.get('default_woo_instance_id', False):
            financial_status_ids = self.env['woo.sale.auto.workflow.configuration'].search(
                [('woo_instance_id', '=', self.env.context.get('default_woo_instance_id', False))]).ids
