...
class WooMetaFieldMappingEpt(models.Model):
    ...
    _meta_mapping_unique_constraint = models.Constraint('unique(woo_meta_key,instance_id,woo_operation,model_id)',
                                                        'WooCommerce Meta Key, WooCommerce Operation and Model must be unique in the Meta Mapping as per WooCommerce Instance.')
