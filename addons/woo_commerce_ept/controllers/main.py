...
class Webhook(http.Controller):
    ...
    @http.route("/delete_product_webhook_odoo", csrf=False, auth="public", type="jsonrpc")
    ...
    @http.route("/restore_product_webhook_odoo", csrf=False, auth="public", type="jsonrpc")
    ...
    @http.route(["/update_order_webhook_odoo", "/delete_order_webhook_odoo"], csrf=False, auth="public", type="jsonrpc")
    ...
    @http.route("/check_webhook", csrf=False, auth="public", type="jsonrpc")
    ...
    @http.route("/update_customer_webhook_odoo", csrf=False, auth="public", type="jsonrpc")
    ...
    @http.route("/delete_customer_webhook_odoo", csrf=False, auth="public", type="jsonrpc")
    ...
    @http.route(["/update_coupon_webhook_odoo", "/restore_coupon_webhook_odoo"], csrf=False, auth="public", type="jsonrpc")
    ...
    @http.route("/delete_coupon_webhook_odoo", csrf=False, auth="public", type="jsonrpc")
