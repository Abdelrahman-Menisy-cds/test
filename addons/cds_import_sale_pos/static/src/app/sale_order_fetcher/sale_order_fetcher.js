...
class CDSSaleOrderFetcher extends EventBus {
...
export const saleOrderFetcherService = {
    dependencies: CDSSaleOrderFetcher.serviceDependencies,
    start(env, deps) {
        return new CDSSaleOrderFetcher(deps);
    },
};

registry.category("services").add("cds_sale_order_fetcher", saleOrderFetcherService);
